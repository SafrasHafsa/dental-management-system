...
<div class="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-emerald-50 rounded-2xl p-4 border border-emerald-100">
        ...
        <p class="text-2xl font-bold text-emerald-900">Rs.<?php echo e(number_format($totalRevenue, 0)); ?></p>
    </div>
    <div class="bg-red-50 rounded-2xl p-4 border border-red-100">
        <p class="text-xs text-red-600 mb-1">Outstanding</p>
        <p class="text-2xl font-bold text-red-900">Rs.<?php echo e(number_format($outstanding, 0)); ?></p>
    </div>
    <div class="bg-blue-50 rounded-2xl p-4 border border-blue-100">
        <p class="text-xs text-blue-600 mb-1">Fully Paid</p>
        <p class="text-2xl font-bold text-blue-900"><?php echo e($paidCount); ?></p>
    </div>
    <div class="bg-amber-50 rounded-2xl p-4 border border-amber-100">
        <p class="text-xs text-amber-600 mb-1">Overdue</p>
        <p class="text-2xl font-bold text-amber-900"><?php echo e($overdueCount); ?></p>
    </div>
</div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\admin\billing.blade.php ENDPATH**/ ?>