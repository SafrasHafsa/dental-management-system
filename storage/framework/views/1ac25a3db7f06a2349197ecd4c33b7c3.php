...
<form method="POST" action="<?php echo e(route('admin.settings.update')); ?>" class="max-w-2xl space-y-5">
    <?php echo csrf_field(); ?>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="clinic_address" rows="2"
                          ...
                          placeholder="123 Main St, Colombo 03"><?php echo e(old('clinic_address', $settings['clinic_address'])); ?></textarea>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="currency"
                       value="<?php echo e(old('currency', $settings['currency'])); ?>"
                       class="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                       placeholder="Rs.">
            </div>
        </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\admin\settings.blade.php ENDPATH**/ ?>