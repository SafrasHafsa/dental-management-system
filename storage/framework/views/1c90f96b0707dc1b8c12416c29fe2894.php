<?php $__env->startSection('title', 'SmileCare Dental Clinic — Your Smile, Our Priority'); ?>
<?php $__env->startSection('description', 'Professional dental care for the whole family in Manila. Book your appointment online today.'); ?>
...
<section class="bg-gray-50 border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $label, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="p-4">
                <p class="text-3xl font-extrabold <?php echo e($color); ?>"><?php echo e($num); ?></p>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
    ...
    <?php else: ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $services->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card hover:shadow-card-hover transition-shadow">
                <div class="p-6">
                    ...
                    <h3 class="font-semibold text-gray-900 mb-2"><?php echo e($category); ?></h3>
                    <ul class="space-y-1">
                        <?php $__currentLoopData = $group->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="text-sm text-gray-500 flex items-center gap-2">
                            ...
                            <?php if($service->base_price): ?>
                                <span class="ml-auto font-medium text-gray-700">Rs.<?php echo e(number_format($service->base_price, 0)); ?></span>
                            <?php endif; ?>
                        </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
        ...
        <div class="text-center mt-8">
            <a href="<?php echo e(route('services')); ?>" class="btn-secondary">View All Services</a>
        </div>
    <?php endif; ?>
</section>
...
<section class="bg-gray-50 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$step, $title, $desc, $colors]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="text-center">
                <div class="w-14 h-14 <?php echo e($colors); ?> rounded-2xl flex items-center justify-center text-2xl font-bold mx-auto mb-4">
                    <?php echo e($step); ?>
        ...
        <div class="text-center mt-10">
            <a href="<?php echo e(route('book.index')); ?>" class="btn-primary">Book Now — It's Free</a>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\public\home.blade.php ENDPATH**/ ?>