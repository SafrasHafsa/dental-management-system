...
<?php $__env->startSection('title', 'My Patients'); ?>
...
<div class="flex items-center justify-between mb-6">
    <div>
        ...
        <p class="text-sm text-gray-500 mt-0.5"><?php echo e($patients->count()); ?> patients you have treated</p>
    </div>
</div>
        ...
        <table id="patients-dt" class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-3.5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center text-primary-700 font-bold text-xs flex-shrink-0">
                                <?php echo e(strtoupper(substr($patient->first_name ?? 'P', 0, 1))); ?>
                    ...
                    <td class="px-6 py-3.5 text-gray-600"><?php echo e($patient->blood_type ?? '—'); ?></td>
                    <td class="px-6 py-3.5 text-gray-600"><?php echo e($patient->user?->phone ?? '—'); ?></td>
                    <td class="px-6 py-3.5">
                        <a href="<?php echo e(route('doctor.patients.show', $patient)); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\doctor\patients.blade.php ENDPATH**/ ?>