...
<div class="flex items-center justify-between mb-6">
    <div class="flex items-center gap-3">
        <a href="<?php echo e(route('staff.appointments')); ?>"
...
<div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
    ...
    <div class="space-y-5">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <a href="<?php echo e(route('staff.patients.show', $appointment->patient)); ?>"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\staff\appointment-show.blade.php ENDPATH**/ ?>