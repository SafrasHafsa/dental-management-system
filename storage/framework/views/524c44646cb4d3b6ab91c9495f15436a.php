<?php $__env->startSection('title', isset($item) ? 'Edit Item' : 'New Item'); ?>
<?php $__env->startSection('page-title', isset($item) ? 'Edit Inventory Item' : 'Add Inventory Item'); ?>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginal6cced52613a484e7295a90162a92d81b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6cced52613a484e7295a90162a92d81b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-item','data' => ['route' => 'staff.billing','icon' => 'receipt','label' => 'Billing']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('nav-item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => 'staff.billing','icon' => 'receipt','label' => 'Billing']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal6cced52613a484e7295a90162a92d81b)): ?>
<?php $attributes = $__attributesOriginal6cced52613a484e7295a90162a92d81b; ?>
...
<div class="mb-4"><a href="<?php echo e(route('staff.inventory')); ?>" class="text-sm text-primary-600 hover:underline">&larr; Back to Inventory</a></div>
<div class="card max-w-lg">
    <h3 class="card-title mb-6"><?php echo e(isset($item) ? 'Edit' : 'Add'); ?> Item</h3>
    <p class="text-gray-400 text-sm">Inventory item form coming soon.</p>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\staff\inventory-item-form.blade.php ENDPATH**/ ?>