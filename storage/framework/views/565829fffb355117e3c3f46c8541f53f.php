...
<div
    x-data="crudModal({
        storeUrl:  '<?php echo e(route('admin.services.store')); ?>',
        updateUrl: '<?php echo e(url('admin/services')); ?>',
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-3.5">
                        <p class="font-medium text-gray-900"><?php echo e($service->name); ?></p>
                        <?php if($service->description): ?>
                            <p class="text-xs text-gray-400 mt-0.5 max-w-xs truncate"><?php echo e($service->description); ?></p>
                        <?php endif; ?>
                    </td>
                    <td class="px-6 py-3.5 text-gray-600"><?php echo e($service->category); ?></td>
                    <td class="px-6 py-3.5 font-medium text-gray-900">
                        <?php echo e($service->base_price ? 'Rs.'.number_format($service->base_price, 0) : '—'); ?>

                    </td>
                    <td class="px-6 py-3.5 text-gray-500">
                        <?php echo e($service->duration_minutes ? $service->duration_minutes.' min' : '—'); ?>

                    </td>
                    <td class="px-6 py-3.5">
                        <span class="text-xs font-semibold px-2 py-0.5 rounded-full
                            <?php echo e($service->is_active ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-500'); ?>">
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                @click="openEdit({
                                    ...
                                    name: <?php echo \Illuminate\Support\Js::from($service->name)->toHtml() ?>,
                                    category: <?php echo \Illuminate\Support\Js::from($service->category)->toHtml() ?>,
                                    base_price: '<?php echo e($service->base_price); ?>',
                                    duration_minutes: '<?php echo e($service->duration_minutes); ?>',
                                    description: <?php echo \Illuminate\Support\Js::from($service->description ?? '')->toHtml() ?>,
                                    is_active: <?php echo e($service->is_active ? 'true' : 'false'); ?>
                            ...
                            <button
                                @click="del(<?php echo e($service->id); ?>, '<?php echo e(url('admin/services')); ?>')"
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <datalist id="category-suggestions">
                        <?php $__currentLoopData = $services->pluck('category')->unique()->sort(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views/admin/services.blade.php ENDPATH**/ ?>