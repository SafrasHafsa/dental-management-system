...
<?php echo $__env->make('partials.appointments-table', [
    'canApprove' => false,
    'showRoute'  => 'admin.appointments.show',
    'storeRoute' => route('admin.appointments.store'),
    'patients'   => $patients,
    'doctors'    => $doctors,
    'services'   => $services,
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\admin\appointments.blade.php ENDPATH**/ ?>