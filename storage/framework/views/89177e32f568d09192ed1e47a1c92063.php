...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="text-xl font-bold text-gray-900"><?php echo e($user->name); ?></h1>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        ...
        <div class="space-y-3 text-sm">
            <div class="flex justify-between py-2 border-b border-gray-50">
                ...
                <span class="text-gray-900"><?php echo e($user->phone ?? '—'); ?></span>
            </div>
            <div class="flex justify-between py-2 border-b border-gray-50">
                <span class="text-gray-500">Status</span>
                <span class="text-xs font-semibold px-2 py-0.5 rounded-full
                    <?php echo e($user->is_active ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-500'); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Dental Managment System\resources\views\admin\user-show.blade.php ENDPATH**/ ?>